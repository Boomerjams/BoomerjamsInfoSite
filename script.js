...
if (contactForm) {
  ...
  contactForm.addEventListener('submit', async (event) => {
    ...
    try {
      ...
      if (successText) {
        successText.textContent = "Your message has been sent successfully. I'll get back to you soon.";
      }
      ...
      if (successText) {
        successText.textContent = 'A draft email has been opened so you can finish sending your message to kobbowork@gmail.com.';
      }
    }
  });
}
